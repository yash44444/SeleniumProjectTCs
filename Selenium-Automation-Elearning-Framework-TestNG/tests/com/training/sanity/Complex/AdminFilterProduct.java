...
public class AdminFilterProduct {
	...
	public void filterProduct(String prodName, String prodPrice, String prodStatus, String prodModel, String prodQtty)
		...
		//status.selectByVisibleText(adminFilterProduct.enterProductStatus(prodStatus));
		status.selectByVisibleText("Enabled");   // selecting status from dropdown
